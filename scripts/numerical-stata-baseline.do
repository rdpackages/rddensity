...
tempfile results
tempname handle
postfile `handle' str16 language str16 precision str32 case str32 metric double value using "`results'", replace
...
program define _rdd_post_density
    ...
    post `handle' ("stata") ("`precision'") ("`case'") ("sd_jk_left") (e(se_ql))
    post `handle' ("stata") ("`precision'") ("`case'") ("sd_jk_right") (e(se_qr))
    post `handle' ("stata") ("`precision'") ("`case'") ("sd_jk_diff") (e(se_q))
    post `handle' ("stata") ("`precision'") ("`case'") ("test_t_jk") (e(T_q))
    post `handle' ("stata") ("`precision'") ("`case'") ("test_p_jk") (e(pv_q))
    ...
    if "`all'" != "" {
        ...
        post `handle' ("stata") ("`precision'") ("`case'") ("sd_jk_p_left") (e(se_pl))
        post `handle' ("stata") ("`precision'") ("`case'") ("sd_jk_p_right") (e(se_pr))
        post `handle' ("stata") ("`precision'") ("`case'") ("sd_jk_p_diff") (e(se_p))
        post `handle' ("stata") ("`precision'") ("`case'") ("test_p_t_jk") (e(T_p))
        post `handle' ("stata") ("`precision'") ("`case'") ("test_p_p_jk") (e(pv_p))
    }
end
